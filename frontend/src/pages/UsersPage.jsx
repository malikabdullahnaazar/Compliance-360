...
const UsersPage = () => {
    ...
    // Effect to fetch all agencies for dropdowns correctly if needed
    useEffect(() => {
        const fetchAllAgencies = async () => {
            try {
                // Fetch with a large page size for dropdowns
                ...
                console.error("Failed to fetch agencies list", error);
            }
        };
        fetchAllAgencies();
    }, []);
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            ...
                                            <div className="flex items-center gap-2 border-l border-gray-200 dark:border-gray-700 pl-3">
                                                ...
                                                >
                                                    ...
                                                    <option value="clinical_leadership">Clinical Leadership</option>
                                                        ...
                                                        <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap">
                                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${u.role === 'superadmin'
                                                                    ...
                                                                    {u.role === 'agency_admin' ? 'Agency Admin' : (u.role || 'user')}
                                                                </span>
                                                            </td>
                                                            <td className="px-6 py-4 whitespace-nowrap">
                                                                <div className="text-sm text-gray-500 dark:text-gray-400">
